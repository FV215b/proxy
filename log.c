...
void logCheckRequest(FILE* log, int uid, char* expire, int cacheStatus){
  if(!log){
...
void logOkCheck(FILE* log, int respStatus,  char* expire){
  if(!log){
    fprintf(log, "log file point to null\n");
    return;
  }
...
void logRespClient(FILE* log, char* response, int malFormed){
  if(!log){
    fprintf(log, "log file point to null\n");
    return;
  }
...
void logTunnelOk(FILE* log, int is_closed){
  if(!log){
    fprintf(log, "log file point to null\n");
    return;
  }
...
void logC_control(FILE* log, char* c_control){
  if(!log){
    fprintf(log,"log file point to null\n");
    return;
  }
...
void logEtag(FILE* log, char* E_tag){
  if(!log){
    fprintf(log,"log file point to null\n");
    return;
  }
